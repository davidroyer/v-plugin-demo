  ...
  methods: {
    ...
    prepareEditorConfig: function prepareEditorConfig(editorConfig) {
      if (Object.keys(this.editorOptions).length > 0 && this.editorOptions.constructor === Object) {
        ...
        merge_1(editorConfig, this.editorOptions);
      }
    },
